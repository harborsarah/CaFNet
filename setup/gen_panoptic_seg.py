...
cfg.MODEL.WEIGHTS = '/home/sfusion/virtualenvs/pytorch38/lib/python3.8/site-packages/detectron2/model_final_cafdb1.pkl'
...
with torch.no_grad():
    for scene_idx in range(0,850):
        ...
        while camera_data['next'] != '':
            ...
            camera_image_path = os.path.join('dataset/nuscenes', camera_image_path)
